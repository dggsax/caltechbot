...
=============
Warning: Not sure what'll happen if you try to run this code when the real mitbot is active
Usually don't need to modify mitbot.py.
To make changes to the actual bot functions, modify plugins/main.py, or add a new plugins file.

How to run rtmbot stuff:
Dependencies
----------
